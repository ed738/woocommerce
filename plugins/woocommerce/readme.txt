...
* Fix - Convert null and '' to 0 before verification to mimic $wpdb->prepare. [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
* Fix - Correct generation of variation name when attribute is 0. [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
...
* Fix - Fix broken design of Single Product template in Twenty Twenty-Two when product had no reviews or additional info. Fix on sale badge being cut off on the Single Product template. [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
...
* Fix - Fixed incorrect tax calculation in edit order for "Local Pickup" shipping method. [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
* Fix - Fixed missing wcpay setup task, task fill page was missing for the woocommerce-payments task [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
...
* Fix - Fix for broken table layout when reordering products on the sorting screen. [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
...
* Fix - Fix shipping display logic country code [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
...
* Fix - WooCommerce Admin plugin deactivation message was causing much unnecessary alarm and has been improved #33592 [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
...
* Add - Add new experimental shipping task flow [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
...
* Update - Removed two-col task list expierments code [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
...
* Update - Update display shipping task logic and add ReviewShippingOptions task [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
* Update - Update review shipping options task complete logic [#33650](https://github.com/woocommerce/woocommerce/pull/33650)
* Update - Update shipping recommendations display logic [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
...
* Update - Uses WC_Data_Store directly to count the shipping zones to avoid any unncessary query to the D.B [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
* Dev - Add playwright e2e README.md [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
* Dev - Add `$transaction_id` as arg to various `payment_complete` hooks. [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
...
* Tweak - Fix code that throws deprecation notices in tests in PHP 8.1 [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
...
* Tweak - Remove blog URL from requests to external IP lookup services. [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
* Tweak - Set default shipping methods based on the OBW selections [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
* Tweak - Show a generic error when trying to process a checkout while offline. [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
...
* Tweak - Update Danish currency symbol to match CLDR R41 spec. [#33573](https://github.com/woocommerce/woocommerce/pull/33573)
